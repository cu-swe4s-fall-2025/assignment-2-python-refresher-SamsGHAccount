...
python print_fires.py --file Agrofood_co2_emission.csv --country "United States of America" --county_column 0 --return_col 3 --info_ret "mean"
python print_fires.py --file Agrofood_co2_emission.csv --country "United States of America" --county_column 0 --return_col 3 --info_ret "median"
python print_fires.py --file Agrofood_co2_emission.csv --country "United States of America" --county_column 0 --return_col 3 --info_ret "stdev"
